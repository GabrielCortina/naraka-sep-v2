...
- [ ] **SETUP-01**: Projeto Next.js 14 criado com Tailwind CSS e shadcn/ui
...
- [ ] **AUTH-01**: Usuário pode fazer login com nome + PIN numérico (4-6 dígitos)
- [ ] **AUTH-02**: PIN armazenado como hash SHA-256 no banco
